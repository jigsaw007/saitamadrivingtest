...
const SetD = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.PUBLIC_URL}/data/setD.json`)
  ...
  const renderResults = () => {
    return (
      <div className="card p-4 shadow">
        <h1 className="text-center" style={{ fontFamily: "'Poppins', sans-serif", color: "#ffc107" }}>
          Quiz Results
        </h1>
  ...
  return (
    <div>
      ...
      <div className="container mt-5 p-5 rounded shadow" style={{ backgroundColor: "#ffffff" }}>
        ...
        <h1 className="text-center mb-4 text-warning" style={{ fontFamily: "'Poppins', sans-serif" }}>
          Set D Quiz
        </h1>
        <p className="text-center mb-4" style={{ fontSize: "18px", fontFamily: "'Roboto', sans-serif" }}>
          Test your knowledge with the Set D Quiz. Answer all questions and aim for the highest score!
        </p>
